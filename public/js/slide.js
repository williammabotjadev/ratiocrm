window.onload = function() {
    ...
    var circle_two = document.getElementById("circle-two");
    var circle_three = document.getElementById("circle-three");
    ...
    function slideAuto() {
            ...
            if(num == 0) {
                circle_one.innerHTML = code;
                circle_two.innerHTML = off_code;
                circle_three.innerHTML = off_code;
            } else if(num == 1) {
                circle_one.innerHTML = off_code;
                circle_two.innerHTML = code;
                circle_three.innerHTML = off_code;
            } else if(num == 2) {
                circle_one.innerHTML = off_code;
                circle_two.innerHTML = off_code;
                circle_three.innerHTML = code;
            }
            num++;
    }
