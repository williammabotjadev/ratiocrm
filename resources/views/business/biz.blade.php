...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="tab-content">
            ...
            <div class="col">
                <a href="{{ route('biz-customers', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Customers Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-suppliers', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Suppliers Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-products', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Products Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-services', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Services Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-transactions', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Transactions Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-reporting', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Reporting Home</a>
            </div>
            </div>
            </div>
            ...
            <div class="col">
                <a href="{{ route('biz-employees', ['id' => $biz->id]) }}" target="_blank" class="btn btn-home btn-home-tabs">Employees Home</a>
            </div>
            </div>
            </div>
        </div>
