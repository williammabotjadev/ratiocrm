...
<div class="container">
    <div class="row justify-content-center">
        <div class="d-flex flex-row justify-content-center align-items-center">
           <form action="{{ route('store-customer', ['id' => $biz->id]) }}" class="form-group" method="POST">
               @csrf
               <fieldset>
            ...
            <div class="w-50 container">
               ...
               <div class="d-flex flex-row mt-2">
                    ...
                    <a href="{{ route('biz-customers', ['id' => $biz->id]) }}" type="button" class="btn btn-danger text-white px-5 page-btn ml-5 btn-ml">Discard</a>
               </div>
